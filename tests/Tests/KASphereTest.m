...
- (void)testSphereIntersection {
    ...
    for(int deg=0; deg<360; deg++) {
        ...
        GHAssertEquals([sphere findIntersectionsForRay:ray withMaxDepth:RAY_MAX_LENGTH],
                       RAY_MAX_LENGTH,
        ...
        GHAssertLessThanOrEqual([sphere findIntersectionsForRay:ray withMaxDepth:RAY_MAX_LENGTH],
                       100.0f,
                       @"Ray %@ should miss sphere %@ (%i degrees)", ray, sphere, deg);
    }
    ...
    GHAssertEquals([sphere findIntersectionsForRay:ray withMaxDepth:RAY_MAX_LENGTH], 90.0f, @"Distance should be 90.0f at center of sphere");
